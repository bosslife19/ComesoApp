...
const handleAddAlreadyExisting = async ()=>{
  ...
  try {
    ...
    const res = await axiosClient.post('/beneficiary/add', {phone});
    if(res.data.error){
...
!invite && (<>
  <Text style={{fontFamily: "Sofia",
                ...
                textAlign:'center',
                top:'2%'
                }}>Add Existing COMESO user as beneficiary</Text>
          <View
            style={{
          ...
          >
            <TextInput
              style={[
                SectionsLogin.input,
                { fontFamily: "SofiaPro", fontSize: 13 },
              ]}
              placeholder="Beneficiary's phone number (e.g.+23361***)"
          ...
          <View style={{ }}>
            <CustomBlueButton
              text="Add"
              onPress={handleAddAlreadyExisting}
              toggleModal={toggleModal}
              buttonSpinner={buttonSpinner}
              setButtonSpinner={setButtonSpinner}
            />
          </View>
  </>)
}

        {
          ...
          style={{
            backgroundColor: "#007AFF", // Blue color for a button feel
            paddingVertical: 12,
        ...
        >
          ...
          >
            Invite New Beneficiary to Comeso
          </Text>
        </TouchableOpacity>
        }
        ...
        INVITE NEW BENEFICIARY TO COMESO
            ...
            >
              <TextInput
                ...
                placeholder="Input beneficiary's name or username"
